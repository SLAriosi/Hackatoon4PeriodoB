...
const UserManagement = ()=>{
    ...
    // Função para buscar a lista de usuários da API Laravel
    const fetchUsers = async ()=>{
        try {
            setLoading(true); // Inicia o loading
            const response = await __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].get('/api/users'); // Endpoint da API Laravel
            setUsers(response.data); // Definindo os usuários
        } catch (err) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__83b1d9._.js.map