(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__11fb64._.js", {
...
const Historico = ()=>{
    ...
    const [filteredHistory, setFilteredHistory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Historico.useEffect": ()=>{
            const fetchHistory = {
                "Historico.useEffect.fetchHistory": async ()=>{
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$reservation$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["getReservationHistory"])(); // Chamada ao serviço mockado
                        setHistory(data);
                        setFilteredHistory(data); // Inicializa com todos os dados
                    } catch (err) {
                        setError('Erro ao carregar o histórico de reservas.');
                    }
                }
            }["Historico.useEffect.fetchHistory"];
            fetchHistory();
        }
    }["Historico.useEffect"], []);
    // Função para filtrar as reservas com base na pesquisa
    const handleSearch = (e)=>{
        const query = e.target.value.toLowerCase();
        setSearch(query);
        const filtered = history.filter((item)=>{
            return item.user.toLowerCase().includes(query) || item.environment.toLowerCase().includes(query) || item.status.toLowerCase().includes(query);
        });
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        type: "text",
                        placeholder: "Pesquisar por usuário, ambiente ou status",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                        ...
                        children: filteredHistory.length > 0 ? filteredHistory.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
...
_s(Historico, "PwoKGOcJ4k7pAXBV1Y+Qav/TyTQ=");
_c = Historico;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__11fb64._.js.map