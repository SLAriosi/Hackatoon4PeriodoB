(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__239091._.js", {
...
__turbopack_export_value__({
  ...
  "input-container": "Perfil-module__mu2SBG__input-container",
  "password-input": "Perfil-module__mu2SBG__password-input",
});
}}),
        ...
        "UserManagement.useEffect": ()=>{
            const fetchUsers = {
                "UserManagement.useEffect.fetchUsers": async ()=>{
                    try {
                        const data = await getUserList(); // Chamada ao serviço para obter a lista de usuários
                        setUsers(data);
                    } catch (err) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__239091._.js.map